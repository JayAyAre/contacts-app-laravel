...
class ContactShareControllerTest extends TestCase
{
  ...
  public function test_user_can_share_contact(): void
  {
    ...
    $this->assertTrue(($sharedContacts->is($contact)) && $contact->is($sharedContacts));
  }
  ...
  /**
   * @depends test_user_can_see_shared_contact
   */
